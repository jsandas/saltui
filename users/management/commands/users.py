...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        try:
            ...
            self.stdout.write(self.style.WARNING('Failed getting user information: ', e))
            self.stdout.write(self.style.WARNING('User data: {}'.format(user_data)))
            self.stdout.write(self.style.WARNING('User data: {}'.format(lastlog_data)))
